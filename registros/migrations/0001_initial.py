# Generated by Django 3.1 on 2020-09-24 21:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jornada', models.CharField(choices=[('mañana', 'Mañana'), ('tarde', 'Tarde')], max_length=50, verbose_name='Jornada')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_pago', models.CharField(choices=[('EF', 'Efectivo'), ('BC', 'Banco'), ('TR', 'Tranferencia')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            name='Docente',
            fields=[
                ('id_docente', models.CharField(default=5000, max_length=15, primary_key=True, serialize=False, verbose_name='id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ManyToManyField(to='registros.Estudiante')),
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registros.persona')),
            ],
            options={
