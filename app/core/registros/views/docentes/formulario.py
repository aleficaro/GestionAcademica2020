...
from app.core.registros.models import Docente
...
class FormularioDocente(ModelForm):
    ...
    def __init__(self, *args, **kwargs):  # se sobreescribe la clase ModelForm del metodo __init__
        ...
        self.fields['persona'].widget.attrs[
            'autofocus'] = True  # se hace el llamdo a todos los componenetes con self y se le indica el campo donde debe estar el cursor
    ...
    class Meta:
        ...
        widgets = {
            'profesion': TextInput(
                attrs={
                    'placeholder': 'Escribe tu profesión actual'  # Se le asigna una descripcioon dentro del campo
                }
            ),
