...
from app.core.registros.models import Jornada
...
class FormularioJornada(ModelForm):
    def __init__(self, *args, **kwargs):  # se sobreescribe la clase ModelForm del metodo __init__
        ...
        self.fields['id_jornada'].widget.attrs['autofocus'] = True  # se hace el llamado a todos los componenetes con self y se le indica el campo donde debe estar el cursor
