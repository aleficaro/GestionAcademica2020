...
from app.core.registros.models import Matricula
...
class FormularioMatricula(ModelForm):
    ...
    def __init__(self, *args, **kwargs):  # se sobreescribe la clase ModelForm del metodo __init__
        ...
        self.fields['estudiante'].widget.attrs['autofocus'] = True  # se hace el llamado a todos los componentes con self y se le indica el campo donde debe estar el cursor
