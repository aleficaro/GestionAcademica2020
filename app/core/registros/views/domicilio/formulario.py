...
from app.core.registros.models import Domicilio
...
class FormularioDomicilio(ModelForm):
    ...
    def __init__(self, *args, **kwargs):  # se sobreescribe la clase ModelForm del metodo __init__
        ...
        self.fields['ciudad'].widget.attrs['autofocus'] = True  # se hace el llamado a todos los componentes con self y se le indica el campo donde debe estar el cursor
