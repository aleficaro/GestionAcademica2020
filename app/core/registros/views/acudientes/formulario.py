...
from app.core.registros.models import Acudiente

# se crea la clase del formulario para ser utilizada en la views a traves de form_class
class FormularioAcudientes(ModelForm):
    ...
    def __init__(self, *args, **kwargs):  # se sobreescribe la clase ModelForm del metodo __init__
        ...
        self.fields['id_acudiente'].widget.attrs['autofocus'] = True # se hace el llamdo a todos los componenetes con self y se le indica el campo donde debe estar el cursor
